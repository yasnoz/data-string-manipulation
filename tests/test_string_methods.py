...
class TestConcatCapitalized(unittest.TestCase):
    def test_john_doe_33_concatenation_capitalized(self):
        """This method should correctly return the full name and the age, and
        capitalize the names if the user inputs names that are not capitalized"""
        self.assertEqual(full_description_concatenation("john", "doe", 33), "John Doe is 33")
...
class TestFStringCapitalized(unittest.TestCase):
    def test_john_doe_33_formatting_capitalized(self):
        """This method should correctly return the full name and the age, and
        capitalize the names if the user inputs names that are not capitalized"""
        self.assertEqual(full_description_formatting("john", "doe", 33), "John Doe is 33")
